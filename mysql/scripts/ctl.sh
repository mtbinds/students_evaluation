...
MYSQL_PIDFILE=/opt/wordpress/mysql/data/mysqld.pid

MYSQL_START="/opt/wordpress/mysql/bin/mysqld_safe --defaults-file=/opt/wordpress/mysql/my.cnf --mysqld=mysqld.bin --socket=/opt/wordpress/mysql/tmp/mysql.sock  --datadir=/opt/wordpress/mysql/data --log-error=/opt/wordpress/mysql/data/mysqld.log  --pid-file=$MYSQL_PIDFILE --lower-case-table-names=1 "
