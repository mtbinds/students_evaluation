...
HTTPD_PIDFILE=/opt/wordpress/apache2/logs/httpd.pid



HTTPD="/opt/wordpress/apache2/bin/httpd -f /opt/wordpress/apache2/conf/httpd.conf"
if [ -f "/opt/wordpress/apps/bitnami/banner/disable-banner" ] ; then
...
. /opt/wordpress/apache2/bin/envvars
