...
function somfrp_from_name_render() { 
	...
	$options = get_option( 'somfrp_gen_settings' );
	$default = __( 'WordPress', 'frontend-reset-password' );
	$value = ( isset( $options['somfrp_from_name'] ) && $options['somfrp_from_name'] ) ? $options['somfrp_from_name'] : '' ;
...
function somfrp_email_address_render() { 
	...
	$options = get_option( 'somfrp_gen_settings' );
	$default = __( 'wordpress@yoursite.com', 'frontend-reset-password' );
	$value = ( isset( $options['somfrp_email_address'] ) && $options['somfrp_email_address'] ) ? $options['somfrp_email_address'] : '' ;
...
function somfrp_request_success_page_render() {
	...
	$options = get_option( 'somfrp_gen_settings' );
	$value = ( isset( $options['somfrp_request_success_page'] ) && $options['somfrp_request_success_page'] ) ? $options['somfrp_request_success_page']: '' ;
...
function somfrp_reset_success_page_render() {
	...
	$options = get_option( 'somfrp_gen_settings' );
	$value = ( isset( $options['somfrp_reset_success_page'] ) && $options['somfrp_reset_success_page'] ) ? $options['somfrp_reset_success_page']: '' ;
