    ...
    public function integration_customizer_controls($controls)
    {
        if (defined('MAILOPTIN_DETACH_LIBSODIUM') === true) {
            ...
            $controls[] = [
                ...
                'description' => __('Select ConvertKit tags that will be added to subscribers.', 'mailoptin')
            ];

        } else {

            $content = sprintf(
                __("%sMailOptin Premium%s allows you to apply tags to subscribers, add subscribers to sequences and loads of other conversion features.", 'mailoptin'),
