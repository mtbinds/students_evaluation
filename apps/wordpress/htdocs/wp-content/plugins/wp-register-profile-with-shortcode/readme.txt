...
* Custom Registration/ Profile fields can be created in the <a href="https://www.aviplugins.com/wp-register-profile-pro/" target="_blank">PRO</a> version of the plugin.



= WP Register Profile PRO =
The <a href="https://www.aviplugins.com/wp-register-profile-pro/" target="_blank">PRO</a> version of this plugin has additional features like. 

* Registration with support for adding additional custom fields.
* Custom registration fields can be sorted by <strong>Drag & Drop</strong>.
...
* Profile image can be used as <strong>Avatar</strong>. If this is enabled then profile image will be used as user <strong>Avatar</strong> throughout the site. When user posts a comment his profile image will be displayed instead of the defalut WordPress <strong>Avatar</strong>.

You can get it <a href="https://www.aviplugins.com/wp-register-profile-pro/" target="_blank">here</a> in <strong>USD 2.00</strong>

= WP User Subscription =
Get Paid when new users register in your site. <a href="https://www.aviplugins.com/wp-user-subscription/" target="_blank">WP User Subscription</a> plugin can be used with <a target="_blank" href="https://wordpress.org/plugins/wp-register-profile-with-shortcode/">WP Register Profile With Shortcode</a>, <a target="_blank" href="https://www.aviplugins.com/wp-register-profile-pro/">WP Register Profile PRO</a> or separetly or with any other plugin.
...
<a href="https://www.aviplugins.com/wp-user-subscription/" target="_blank">Click here</a> to get full details about the plugin. This plugin is available for <strong>USD 2.50</strong>.
...
If you want to translate the plugin in your language please translate the sample .PO file and mail me the the file at demoforafo@gmail.com and I will include that in the language file. Sample .PO file can be downloaded from <a href="https://www.aviplugins.com/language-sample/wp-register-profile-with-shortcode-es_ES.po" target="_blank">here</a>


== Frequently Asked Questions ==

1. Please email me at demoforafo@gmail.com for any queries or Contact me here https://www.aviplugins.com/support.php

== Screenshots ==

1. Registration form
2. Enable / Disable Registration Form Fields
3. Other Settings
4. Success Message Settings
5. Email Settings
6. Shortcodes
...
= 3.2.5 =
* Now compatible with <a href="https://wordpress.org/plugins/contact-form-with-shortcode/">Contact Form With Shortcode</a> plugin.
...
= 2.2.0 =
* Code updated to make this plugin compatible with <a href="https://www.aviplugins.com/wp-user-subscription/">WP User Subscription</a> plugin.
