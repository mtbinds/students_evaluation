...
define ('AMR_USERS_STORE_URL','https://wpusersplugin.com');
...
function amr_users_get_plugin_version($licenses) {
...
function amr_users_show_version ($version_data) {
  ...
  public 'url' => string 'https://wpusersplugin.com/downloads/amr-users/?changelog=1' (length=62)
  public 'homepage' => string 'http://wpusersplugin.com/downloads/amr-users/' (length=50)
  public 'package' => string 'https://wpusersplugin.com/?edd_action=package_download&id=4213&key=001fe02f8ba95e799d29efedf9e80885&expires=MTQxMzg3Nzg1Nw%3D%3D' (length=127)
  public 'download_link' => string 'https://wpusersplugin.com/?edd_action=package_download&id=4213&key=001fe02f8ba95e799d29efedf9e80885&expires=MTQxMzg3Nzg1Nw%3D%3D' (length=127)
  public 'sections'
	*/
...
// check if we should be doing any form processing and was the post from this page
	...
	!empty($_POST['get_plugin_version'] )
		...
		elseif (!empty($_POST['get_plugin_version'])) {
			//amr_users_get_plugin_version($licenses);
		}
