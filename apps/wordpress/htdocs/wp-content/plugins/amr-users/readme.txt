=== amr users ===
Contributors: anmari
Tags: user, users, reports, lists, members, membership, csv, export
Version: 4.26
...
More information: [wpusersplugin.com](https://wpusersplugin.com/).
...
*   change sort direction html entity to use &uarr; and &darr;  for more consistent appearance.  CSS classes are available so you can override the appearance using css contet pseudo classes.
...
1. Default list 1
2. Default list 2
3. Meta Keys - exclude and delete tool
4. Fields, nice names and option to show in wp
5. Select fields to display and sort order
6. Format fields 
7. Include or Exclude
