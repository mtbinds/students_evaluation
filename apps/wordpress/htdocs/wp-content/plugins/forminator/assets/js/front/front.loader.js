...
(function ($, window, document, undefined) {
	...
	$.extend(ForminatorLoader.prototype, {
					...
					success: function (data) {
						if (data.success) {
							...
							if (response.pagination_config) {
								...
								window.Forminator_Cform_Paginations[param.id] = response.pagination_config;
							}
		...
		render_html: function (html, style, script) {
			...
			wrapper_message = this.$el.find('.forminator-cform-response-message');
			...
			if (message) {
				$('#forminator-module-' + id + '[data-forminator-render=' + render_id + '] .forminator-cform-response-message')
					.replaceWith(message);
