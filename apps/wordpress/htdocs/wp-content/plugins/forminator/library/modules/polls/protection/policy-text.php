<div class="wp-suggested-text">
	...
	<p>
		<?php esc_html_e( 'We use Google Drive and Google Sheet to manage our integration data. Their privacy policy can be found here : https://policies.google.com/privacy?hl=en.',
		                  Forminator::DOMAIN ); ?>
	</p>
