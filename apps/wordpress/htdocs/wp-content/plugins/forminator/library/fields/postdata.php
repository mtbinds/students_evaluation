...
class Forminator_Postdata extends Forminator_Field {
	...
	public function defaults() {
		return apply_filters( 'forminator_post_data_defaults_settings',
		                      array(
			                      'data_status'            => 'pending',
...
//		return $autofill_settings;
	...
	public function get_post_title( $id, $name, $field, $required, $design ) {
		return apply_filters( 'forminator_field_postdata_post_title',
		                      $this->_get_post_field( $id, $name, $field, $required, 'post_title', 'text', 'forminator-input', 'post-title', array(), '', $design ) );
	}
	...
	public function get_post_excerpt( $id, $name, $field, $required, $design ) {
		return apply_filters( 'forminator_field_postdata_post_excerpt',
		                      $this->_get_post_field( $id, $name, $field, $required, 'post_excerpt', 'textarea', 'forminator-textarea', 'post-excerpt', array(), '', $design ) );
	}
	...
	public function get_post_image( $id, $name, $field, $required, $design ) {
		return apply_filters( 'forminator_field_postdata_post_image',
		                      $this->_get_post_field( $id, $name, $field, $required, 'post_image', 'file', 'forminator-upload', 'post-image', array(), '', $design ) );
	}
	...
	public function get_post_category( $id, $name, $field, $required, $multiple = false ) {
		...
		return apply_filters( 'forminator_field_postdata_post_category',
		                      $this->_get_post_field( $id, $name, $field, $required, 'post_category', 'select', 'forminator-select', 'post-category', $options, $value, $design, $allow_multiple ) );
	}
	...
	public function get_post_tag( $id, $name, $field, $required, $multiple = false ) {
		...
		return apply_filters( 'forminator_field_postdata_post_tag',
		                      $this->_get_post_field( $id, $name, $field, $required, 'post_tags', 'select', 'forminator-select', 'post-tags', $options, $value, $design, $allow_multiple ) );
	}
			...
			if ( empty( $data ) ) {
				...
				if ( ! empty( $post_category ) && empty( $category ) ) {
					$postdata_post_category_validation_message          = apply_filters(
						...
						( ! empty( $setting_required_message ) ? $setting_required_message : __( 'This field is required. Please select a post category', Forminator::DOMAIN ) ),
						$id
					);
				...
				if ( ! empty( $post_tags ) && empty( $tags ) ) {
					$postdata_post_tag_validation_message           = apply_filters(
						...
						( ! empty( $setting_required_message ) ? $setting_required_message : __( 'This field is required. Please select a post tag', Forminator::DOMAIN ) ),
						$id
					);
