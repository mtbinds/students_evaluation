...
<div class="copyright-wrapper">
    <div class="copyright">
        <p><?php echo esc_html(get_theme_mod('vw_education_lite_footer_copy',__('Copyright 2016 -','vw-education-lite'))); ?> <?php vw_education_lite_credit(); ?></p>
        <?php $theme_lay = get_theme_mod( 'vw_education_lite_scroll_top_alignment','Right');
            if($theme_lay == 'Left'){ ?>
