...
";
    ...
    {
        return new Twig_Source("", "columns_definitions/column_definitions_form.twig", "/opt/wordpress/apps/phpmyadmin/htdocs/templates/columns_definitions/column_definitions_form.twig");
    }
}
